...
import {presignClient} from "../../index.js";
import {v4 as uuidV4} from 'uuid'
// Put or upload an object to a bucket.
const uploadObjectinBucket = async (bucketName: string, userid: string) => {
    try {
        ...
        const presignedUrl = await getSignedUrl(presignClient, command, {expiresIn: 600}) // 10 minutes
